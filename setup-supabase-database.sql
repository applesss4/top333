...
-- 访问: https://paumgahictuhluhuudws.supabase.co/project/default/sql
...
CREATE POLICY "Service role can access all user_sessions" ON public.user_sessions
    FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
